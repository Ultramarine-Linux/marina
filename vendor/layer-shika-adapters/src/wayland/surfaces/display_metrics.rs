...
impl DisplayMetrics {
    ...
    pub fn new(scale_factor: f32, has_fractional_scale: bool) -> Self {
        ...
        Self {
            ...
            configured_scale_factor: scale_factor,
        }
    }
    ...
    pub fn update_scale_factor(&mut self, scale_120ths: u32) -> f32 {
        let compositor_scale = DomainScaleFactor::from_120ths(scale_120ths).value();
        let new_scale =
            DomainScaleFactor::from_raw(compositor_scale * self.configured_scale_factor);
