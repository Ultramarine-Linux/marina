...
portmaster_launch_binary := "target/" + target + "/release/marina-portmaster-launch"
...
deploy-portmaster: portmaster-helper-build
    ...
    scp {{ssh_opts}} "{{portmaster_launch_binary}}" "{{deploy_target}}:/usr/libexec/marina-portmaster-launch.new"
